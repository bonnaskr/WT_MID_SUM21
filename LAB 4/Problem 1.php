			...
			<Fieldset>
				...
				<table align="center">
					...
					<tr valign="top">
						...
						<td>
							<input type="checkbox" name="hr[]" value="A friend or colleauge">A friend or colleauge <br>
							<input type="checkbox" name="hr[]" value="Google">Google<br>
							<input type="checkbox" name="hr[]" value="Blog Post">Blog Post<br>
							<input type="checkbox" name="hr[]" value="News Article">News Article
						</td>
						<td><font color="red"><?php echo $err_hr;?></font></td>
					</tr>
					<tr>
						<td>Bio</td>
						<td><textarea id="bio" name="bio"><?php echo $bio; ?></textarea></td>
						<td> <font color="red">  <?php echo $bio_err; ?> </font> </td>
					</tr>
					<tr>
						<td colspan="3" align="center"><button type="submit" name="submit" id="submit">register</button></td>
					</tr>
